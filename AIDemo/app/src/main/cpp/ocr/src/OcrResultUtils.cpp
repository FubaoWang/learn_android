...
OcrResultUtils::OcrResultUtils(JNIEnv *env, OcrResult &ocrResult, jobject boxImg) {
    ...
    jclass jOcrResultClass = env->FindClass("com/example/aidemo/ocr/OcrResult");
...
jobject OcrResultUtils::newJPoint(cv::Point &point) {
    jclass clazz = jniEnv->FindClass("com/example/aidemo/ocr/Point");
    if (clazz == NULL) {
...
jobject OcrResultUtils::getTextBlock(TextBlock &textBlock) {
    ...
    jclass clazz = jniEnv->FindClass("com/example/aidemo/ocr/TextBlock");
    if (clazz == NULL) {
